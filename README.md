...
**tiny-gp-plus.py** displays dynamic graphs of error and mean tree size, has a bloat-control option, and produces nicer, graphic output (you'll need to install https://pypi.org/project/graphviz/).
